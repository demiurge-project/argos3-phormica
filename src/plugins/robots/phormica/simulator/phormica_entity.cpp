...
namespace argos {
   ...
   CPhormicaEntity::CPhormicaEntity():
   ...
   CPhormicaEntity::CPhormicaEntity( const std::string& str_id,
   ...
   void CPhormicaEntity::Init(TConfigurationNode& t_tree) {
      try {
         /* Init parent */
         ...
         THROW_ARGOSEXCEPTION_NESTED("Failed to initialize phormica entity \"" << GetId() << "\".", ex);
      }
   }
   ...
   void CPhormicaEntity::EnableLEDs(CLEDMedium& c_medium) {
   ...
   void CPhormicaEntity::DisableLEDs() {
   ...
   void CPhormicaEntity::AddLED(const CVector3& c_offset,
   ...
   REGISTER_ENTITY(CPhormicaEntity,
                   "phormica",
                   "David Garzon-Ramos - <dgarzonr@ulb.ac.be>",
                   "1.0",
                   "A stretchable 3D block.",
                   "The block entity can be used to model walls, obstacles or block-shaped grippable\n"
                   ...
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <phormica id=\"block1\" size=\"0.75,0.1,0.5\" movable=\"false\">\n"
                   ...
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <phormica id=\"block1\" size=\"0.75,0.1,0.5\" movable=\"true\" mass=\"2.5\">\n"
                   "      <body position=\"0.4,2.3,0\" orientation=\"45,0,0\" />\n"
                   "    </phormica>\n"
                   "    ...\n"
                   "  </arena>\n\n"
                   ...
                   "The 'size' attribute specifies the size of the block along the three axes, in\n"
                   "the X,Y,Z order. When you add a block, imagine it initially unrotated and\n"
                   ...
                   "the block won't move. When the attribute is set to 'true', the block is movable\n"
                   "upon pushing or gripping. When an object is movable, the 'mass' attribute is\n"
                   "required.\n"
                   "The 'mass' attribute quantifies the mass of the block in kg.\n"
                   "The 'body/position' attribute specifies the position of the base of the block in\n"
                   "the arena. The three values are in the X,Y,Z order.\n"
                   "The 'body/orientation' attribute specifies the orientation of the 3D block. All\n"
                   ...
                   "It is possible to add any number of colored LEDs to the block. In this way,\n"
                   "the block is visible with a robot camera. The position and color of the\n"
                   ...
                   "    ...\n"
                   "  </arena>\n\n"
                   "In the example, four LEDs are added to the block. The LEDs have\n"
                   "different colors and are located one on the top and three\n"
                   "around the block. The LEDs are managed by the LED medium declared in\n"
   ...
   REGISTER_STANDARD_SPACE_OPERATIONS_ON_COMPOSABLE(CPhormicaEntity);
