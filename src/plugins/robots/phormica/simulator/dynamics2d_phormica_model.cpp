...
#include "dynamics2d_phormica_model.h"
...
namespace argos {
   ...
   CDynamics2DPhormicaModel::CDynamics2DPhormicaModel(CDynamics2DEngine& c_engine,
   ...
   REGISTER_STANDARD_DYNAMICS2D_OPERATIONS_ON_ENTITY(CPhormicaEntity, CDynamics2DPhormicaModel);
