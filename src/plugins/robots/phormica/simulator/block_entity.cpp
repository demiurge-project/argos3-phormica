...
namespace argos {
   ...
   CBlockEntity::CBlockEntity(const std::string& str_id,
   ...
   void CBlockEntity::Init(TConfigurationNode& t_tree) {
      try {
         ...
         THROW_ARGOSEXCEPTION_NESTED("Failed to initialize block entity \"" << GetId() << "\".", ex);
      }
   }
   ...
   void CBlockEntity::EnableLEDs(CLEDMedium& c_medium) {
   ...
   void CBlockEntity::AddLED(const CVector3& c_offset,
  ...
  REGISTER_ENTITY(CBlockEntity,
                   ...
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <block id=\"block1\" size=\"0.75,0.1,0.5\" movable=\"false\">\n"
                   ...
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <block id=\"block1\" size=\"0.75,0.1,0.5\" movable=\"true\" mass=\"2.5\">\n"
                   "      <body position=\"0.4,2.3,0\" orientation=\"45,0,0\" />\n"
                   "    </block>\n"
                   "    ...\n"
                   "  </arena>\n\n"
